...
def save_results(evaluation_results, stats, output_file, output_format=None):
    """Save the evaluation results and statistics to a file."""
    output = {
        "statistics": stats,
...
def main():
    ...
    # Save results
    save_results(evaluation_results, stats, args.output_file, args.output_format)
